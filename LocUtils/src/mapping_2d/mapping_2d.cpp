 ...
 * @version: 
 * @Author: lxy
 * @Date: 2023-07-06 17:44:49
 * @LastEditors: lxy
 * @LastEditTime: 2023-07-07 09:27:30
 */

#include "LocUtils/mapping_2d/mapping_2d.hpp"
...
void Mapping2D::Visualize2DScan(Scan2d::Ptr scan, const SE2& pose, cv::Mat& image, const Vec3b& color, int image_size,
...
void Mapping2D::ExpandSubmap() {
    ...
    // debug
    // cv::imwrite("/home/lxy/carto_ws/" + std::to_string(last_submap->GetId()) + ".png",
