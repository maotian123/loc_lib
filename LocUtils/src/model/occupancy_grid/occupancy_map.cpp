...
void OccupancyMap::DebugOccupancyMap(std::shared_ptr<Frame> frame, GridMethod method)
{
    this->AddLidarFrame(frame,method);
    cv::imshow("occupy_map",GetOccupancyGridBlackWhite());
    cv::waitKey(10);
}
