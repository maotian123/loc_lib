 ...
 * @version: 
 * @Author: lxy
 * @Date: 2023-07-06 17:58:03
 * @LastEditors: lxy
 * @LastEditTime: 2023-07-07 09:04:48
 */
#ifndef LOCUTILS_MAPPING_2D_LOOP_CLOSING_HPP_
#define LOCUTILS_MAPPING_2D_LOOP_CLOSING_HPP_
#include "LocUtils/common/eigen_types.h"
#include "LocUtils/mapping_2d/multi_resolution_likelihood_field.hpp"
...
class LoopClosing {
   public:
    ...
    LoopClosing() { debug_fout_.open("/home/lxy/carto_ws/loops.txt"); }
